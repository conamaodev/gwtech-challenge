...
describe('Test the filterUsersByCompanyGroup', () => {
    it('should receive a list of users and return only users works for a company group', () => {
        const usersFiltered = filterUsersByCompanyGroup_1.default(mocks_1.users);
    ...
    it('should receive a list of users and return void array because no have a company group', () => {
        const usersFiltered = filterUsersByCompanyGroup_1.default(mocks_1.usersWithoutCompanyGroup);
        expect(usersFiltered).toHaveLength(0);
        expect(usersFiltered).toStrictEqual([]);
    });
    it('should receive a list of users and a company name and return only users work for the company received ' +
        'if the company participates a company group', () => {
        const company_name = 'Johns Group';
        const usersFiltered = filterUsersByCompanyGroup_1.default(mocks_1.users, company_name);
    ...
    it('should receive a list of users and a company name and return void array because ' +
...
describe('Test the formatUsersPosts', () => {
    it('should receive a list of users and posts and return user posts', () => {
        const usersPosts = formatUsersPosts_1.default(mocks_1.users, mocks_1.posts);
